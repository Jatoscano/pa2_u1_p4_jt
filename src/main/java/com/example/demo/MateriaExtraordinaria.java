...
public class MateriaExtraordinaria {
	...
	public String toString() {
		return "MateriaExtraordinaria [nombre=" + nombre + ", cantidadCreditos=" + cantidadCreditos + ", getNombre()="
				+ getNombre() + ", getCantidadCreditos()=" + getCantidadCreditos() + ", getClass()=" + getClass()
